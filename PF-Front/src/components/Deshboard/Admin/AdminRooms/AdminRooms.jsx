...
const AdminRooms = () => {
  ...
  const { getRootProps: getBath1RootProps, getInputProps: getBath1InputProps } =
    useDropzone({ onDrop: onDropBath1 });

  const { getRootProps: getBath2RootProps, getInputProps: getBath2InputProps } =
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const bathImage1URL = bathImage1 ? await uploadImage(bathImage1) : null;
      const bathImage2URL = bathImage2 ? await uploadImage(bathImage2) : null;
      ...
      if (
        ...
        alert("You Must cComplete All The Fields To Create The Room");
        return;
      }
                ...
                <Grid container spacing={2}>
                  <Grid item xs={4} sm={3} md={2}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Sauna")}
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Jacuzzi")}
                          onChange={handleFacilityChange}
                          value="Jacuzzi"
                        />
                      }
                  ...
                  <Grid item xs={4} sm={3} md={2}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Private Pool")}
                          onChange={handleFacilityChange}
                          value="Private Pool"
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Free Mini Bar")}
                          onChange={handleFacilityChange}
                          value="Free Mini Bar"
                        />
                      }
                  ...
                  <Grid item xs={4} sm={3} md={2}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Welcome Gift")}
                          onChange={handleFacilityChange}
                          value="Welcome Gift"
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Airport Pickup")}
                          onChange={handleFacilityChange}
                  ...
                  <Grid item xs={4} sm={3} md={2}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Party Room")}
                          onChange={handleFacilityChange}
                          value="Party Room"
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Safe Box")}
                          onChange={handleFacilityChange}
                          value="Safe Box"
                        />
                      }
                  ...
                  <Grid item xs={4} sm={3} md={2}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={roomFacilities.includes("Smart TV")}
                          onChange={handleFacilityChange}
                          value="Smart TV"
                        />
                      }
            ...
            <Grid container direction="row" alignItems="center" spacing={2}>
              ...
              >
                ...
                {bedImage ? (
                  ...
                  <p style={{ margin: 0 }}>
                    Drag and drop the bed image here, or click to select
                  </p>
                )}
              </div>
              <div
              ...
              >
                ...
                {bathImage1 ? (
                  ...
                  <p style={{ margin: 0 }}>
                    Drag and drop the first bath image here, or click to select
                  </p>
                )}
              </div>
              <div
              ...
              >
                ...
                {bathImage2 ? (
                  ...
                  <p style={{ margin: 0 }}>
                    Drag and drop the second bath image here, or click to select
                  </p>
                )}
              </div>
            </Grid>
