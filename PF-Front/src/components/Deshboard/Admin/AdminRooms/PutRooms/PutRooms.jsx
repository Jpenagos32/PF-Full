...
const PutRooms = () => {
  ...
  return (
    <Box>
      <Grid marginTop={"2rem"} item xs={12} sm={12} md={6} lg={6} xl={6}>
      ...
      {roomData && Object.keys(roomData).length > 0 && (
        <Grid container columnSpacing={4} marginTop={"20px"}>
          <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
            <Card>
              <CardContent>
                <Typography variant="h5">Room Name: {roomData.name}</Typography>
                <br />
                ...
                <Typography variant="body1">
                  Facilities:{" "}
                  {roomData.facilities && roomData.facilities.join(", ")}
                </Typography>
                <br />
                <Typography variant="body1">
                  Room Description: {roomData.room_description}
                </Typography>{" "}
                <br />
                <CardMedia
                  component="img"
          ...
          <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
            <PutRoomsBoard props={roomData} roomNum={roomInfo.room_number} />
          </Grid>
        </Grid>
      )}
