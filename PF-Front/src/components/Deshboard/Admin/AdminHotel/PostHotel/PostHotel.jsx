...
const PostHotel = () => {
    ...
    const [hotelNIU, setHotelNIU] = useState("");
    const [translatorChecked, setTranslatorChecked] = useState(false);
    const [touristGuideChecked, setTouristGuideChecked] = useState(false);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post("/hotel", requestData);
