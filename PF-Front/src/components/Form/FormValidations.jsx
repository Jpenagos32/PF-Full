export const validation = (formData) => {
  ...
  if (formData.identification.trim() === "") {
    errors.identification = "The Identification field is required";
  } else if (!/^\d+$/.test(formData.identification.trim())) {
    errors.identification = "The Identification field can only contain numbers";
  }
